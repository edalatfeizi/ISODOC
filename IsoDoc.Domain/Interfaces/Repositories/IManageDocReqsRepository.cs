...
namespace IsoDoc.Domain.Interfaces.Repositories
{
    public interface IManageDocReqsRepository
    {
        ...
        Task<List<Document>> GetDocumentsByDepCode(string depCode);
        Task<List<Document>> GetDocumentsByType(DocumentType docType);
        ...
        Task<List<DocRequestChatMessage>> GetDocRequestChatMessagesAsync(int docReqId);
