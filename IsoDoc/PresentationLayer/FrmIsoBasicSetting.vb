Public Class FrmIsoBasicSetting
    ...
    Private Sub FilldgdRegist()
        ...
        dt_regist.DefaultView.RowFilter = "MdepCode='" & dgdMdepart.Item(dgdMdepart.CurrentCell.RowNumber, 0) & "'"
    ...
    Private Sub BtnSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnSave.Click
        Bus_MdepDoc1.InsertMdepDoc(DgdFileName.Item(DgdFileName.CurrentCell.RowNumber, 0), dgdMdepart.Item(dgdMdepart.CurrentCell.RowNumber, 0))
        FilldgdRegist()
    End Sub

    Private Sub SimpleButton2_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SimpleButton2.Click
        Bus_MdepDoc1.DeleteMdepDoc(dgdRegist.Item(dgdRegist.CurrentCell.RowNumber, 0))
        FilldgdRegist()
    End Sub

   
    Private Sub SimpleButton3_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SimpleButton3.Click
        Bus_BasicSetting1.Insert(dgdAllUser.Item(dgdAllUser.CurrentCell.RowNumber, 0))
        FilldgdNotInAlarm()
        FilldgdInAlarm()
    End Sub

    Private Sub SimpleButton1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SimpleButton1.Click
        Bus_BasicSetting1.Delete(dgdUserAlarm.Item(dgdUserAlarm.CurrentCell.RowNumber, 0))
        FilldgdNotInAlarm()
        FilldgdInAlarm()
    End Sub
