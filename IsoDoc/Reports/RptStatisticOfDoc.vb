...
Public Class RptStatisticOfDoc
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "IsoDoc.RptStatisticOfDoc.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptStatisticOfDoc
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptStatisticOfDoc = New RptStatisticOfDoc()
        rpt.Site = Me.Site
        Return rpt
    End Function
