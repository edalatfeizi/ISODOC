...
Public Class RptMasterList
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "IsoDoc.RptMasterList.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_CurDate() As CrystalDecisions.[Shared].IParameterField
        Get
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_CurDate_Date() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedRptMasterList
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptMasterList = New RptMasterList()
        rpt.Site = Me.Site
        Return rpt
    End Function
