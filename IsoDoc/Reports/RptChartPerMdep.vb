...
Public Class RptChartPerMdep
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "IsoDoc.RptChartPerMdep.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptChartPerMdep
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptChartPerMdep = New RptChartPerMdep()
        rpt.Site = Me.Site
        Return rpt
    End Function
